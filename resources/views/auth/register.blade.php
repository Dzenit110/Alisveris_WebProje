...
<head>
    <meta charset="utf-8" />
    <title>Register - Online Kolay Alışveriş
    </title>
                                ...
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="padding_eight_all bg-white">
                                        <div class="heading_s1">
                                            <h1 class="mb-5"> Hesap Oluştur</h1>
                                            <p class="mb-30">Daha önce hesabınız var mı?<a href="{{ route('login') }}">Giriş Yap</a></p>
                                        </div>
...
<form method="POST" action="{{ route('register') }}">
    ...
    <div class="form-group">
        <input type="text" id="name" required="" name="name" placeholder="Kullanıcı Adı Yazınız" />
    </div>
    <div class="form-group">
        <input type="email" id="email" required="" name="email" placeholder="Email Yazınız" />
    </div>
    <div class="form-group">
        <input required="" type="password" id="password" name="password" placeholder="Şifre Yazınız" />
    </div>
    <div class="form-group">
    ...
    <div class="login_footer form-group mb-50">
        <div class="chek-form">
            <div class="custome-checkbox">
                <label><span>Şifrede en  az 8  karakter olmalı !!</span></label>
            </div>
        </div>
