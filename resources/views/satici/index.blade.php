...
@if($status === 'active')
	<h4>Satici Hesap <span class="text-success">Active</span> </h4>
	@else
	<h4>Satici Hesap <span class="text-danger">InActive</span> </h4>
	<p class="text-danger"><b> Lütfen bekleyin Admin hesabınızı kontrol edip onaylayacaktır</b></p>
	@endif
