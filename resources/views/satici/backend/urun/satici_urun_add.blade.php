...
<div class="card">
  <div class="card-body p-4">
      ...
      <form id="myForm" method="post" action="{{ route('satici.store.urun') }}" enctype="multipart/form-data" >
			@csrf
	    ...
	    <div class="row">
           ...
           <div class="border border-3 p-4 rounded">
			...
			<div class="form-group mb-3">
				...
				<input type="text" name="urun_name" class="form-control" id="inputProductTitle" placeholder="Enter product title">
			  </div>

            <div class="mb-3">
				<label for="inputProductTitle" class="form-label">Product Tags</label>
				<input type="text" name="urunt_tags" class="form-control visually-hidden" data-role="tagsinput" value="new product,top product">
			  </div>

			  <div class="mb-3">
				<label for="inputProductTitle" class="form-label">Product Size</label>
				<input type="text" name="urun_size" class="form-control visually-hidden" data-role="tagsinput" value="Small,Midium,Large ">
			  </div>

			  <div class="mb-3">
				<label for="inputProductTitle" class="form-label">Product Color</label>
				<input type="text" name="urun_color" class="form-control visually-hidden" data-role="tagsinput" value="Red,Blue,Black">
			  </div>
  ...
  <script type="text/javascript">
  		...
  		$(document).ready(function(){
  			$('select[name="category_id"]').on('change', function(){
  				...
  				if (category_id) {
  					$.ajax({
  						url: "{{ url('/satici/subcategory/ajax') }}/"+category_id,
  						type: "GET",
  						dataType:"json",
