...
<div class="page-content"> 
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Düzenle Blog Kategori </div>
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
								</li>
								<li class="breadcrumb-item active" aria-current="page">Düzenle Blog Kategori </li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
...
<div class="col-lg-10">
	<div class="card">
		...
		<form id="myForm" method="post" action="{{ route('update.blog.category') }}" enctype="multipart/form-data" >
			...
			<div class="row mb-3">
				<div class="col-sm-3">
					<h6 class="mb-0">Blog Kategori Adı</h6>
				</div>
...
<script type="text/javascript">
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages :{
                blog_category_name: {
                    required : 'Lütfen Blog Kategori Adı Giriniz',
                },
            },
            errorElement : 'span', 
