...
<div class="page-content"> 
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Düzenle Blog Post </div>
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
								</li>
								<li class="breadcrumb-item active" aria-current="page">Düzenle Blog Post </li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
		...
		<form id="myForm" method="post" action="{{ route('update.blog.post') }}" enctype="multipart/form-data" >
		 ...
		 <div class="row mb-3">
			...
			<div class="row mb-3">
				...
				<div class="form-group col-sm-9 text-secondary">
					<input type="text" name="post_baslik" class="form-control"  value="{{ $blogpost->post_baslik }}" />
				</div>
			</div>
...
<div class="row mb-3">
				...
				<div class="form-group col-sm-9 text-secondary">
					<textarea name="post_kisa_tanim" class="form-control" id="inputProductDescription" rows="3">
					{{ $blogpost->post_kisa_tanim }}
					</textarea>
				</div>
			</div>
			...
			<div class="row mb-3">
				...
				<div class="form-group col-sm-9 text-secondary">
					<textarea id="mytextarea" name="post_uzun_tanim">
                 {!! $blogpost->post_uzun_tanim !!}
					 </textarea>
				</div>
			</div>
