...
<div class="page-content"> 
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Bölge Ekle </div>
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
								</li>
								<li class="breadcrumb-item active" aria-current="page">Bölge Ekle </li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
...
<div class="col-lg-10">
 ...
 <form id="myForm" method="post" action="{{ route('store.bolge') }}"   >
			@csrf
	 	...
	 	<select name="bolum_id" class="form-select mb-3" aria-label="Default select example">
           ...
           <div class="row mb-3">
				...
				<div class="form-group col-sm-9 text-secondary">
					<input type="text" name="bolge_name" class="form-control"   />
				</div>
			</div>
