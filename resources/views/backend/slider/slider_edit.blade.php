...
<div class="page-content"> 
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Düzenle Slider </div>
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
								</li>
								<li class="breadcrumb-item active" aria-current="page">Düzenle Slider </li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
	...
	<div class="card">
		...
		<form id="myForm" method="post" action="{{ route('update.slider') }}" enctype="multipart/form-data" >
		 ...
		 <input type="hidden" name="old_img" value="{{ $sliders->slider_image }}">
			...
			<div class="row mb-3">
				<div class="col-sm-3">
					<h6 class="mb-0">Slider Başlık</h6>
				</div>
			...
			<div class="row mb-3">
				<div class="col-sm-3">
					<h6 class="mb-0">Kısa Başlık</h6>
				</div>
				<div class="form-group col-sm-9 text-secondary">
					<input type="text" name="kisa_title" class="form-control" value="{{ $sliders->kisa_title }}"   />
				</div>
			</div>
