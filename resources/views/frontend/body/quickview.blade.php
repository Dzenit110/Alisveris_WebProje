                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-xs-12 mb-md-0 mb-sm-5">
                        <div class="detail-gallery">
                            ...
                            <!-- MAIN SLIDES -->
                            <img src=" " alt="urun image" id="pimage" />
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="detail-info pr-30 pl-30">
                            ...
                            <div class="attr-detail attr-size mb-30" id="sizeArea">
                                ...
                                <strong class="mr-10" style="width:60px;">Boyut : </strong>
                            ...
                            <div class="attr-detail attr-size mb-30" id="colorArea">
                                ...
                                <strong class="mr-10" style="width:60px;">Renk : </strong>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="font-xs">
                                        <ul>
                                            <li class="mb-5">Marka: <span class="text-brand" id="pbrand"> </span></li>
                                            <li class="mb-5">Kategori:<span class="text-brand" id="pcategory"> </span></li>
                                            <li class="mb-5">Satici:<span class="text-brand" id="pvendor_id"> </span></li>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="font-xs">
                                        <ul>
                                            <li class="mb-5">Ürün Code : <span class="text-brand" id="pcode"> </span></li>
                                            <li class="mb-5">Stok:<span class="badge badge-pill badge-success" id="aviable" style="background:green; color: white;"> </span>
