...
<div class="page-header breadcrumb-wrap">
                    ...
                    <div class="col-12 col-lg-8 mx-auto">
                        <div class="shop-product-fillter">
                            <div class="totall-product">
                                <p>We have <strong class="text-brand">{{ count($saticiler) }}</strong> vendors now</p>
                            </div>
  ...
  <a href="{{ route('satici.detay',$satici->id) }}">
   ...
   <span class="font-small total-product">{{ count($urunler) }} urunler</span>
                                ...
                                <div class="vendor-info mb-30">
                                    <ul class="contact-infor text-muted">
                                        <li><img src="assets/imgs/theme/icons/icon-location.svg" alt="" /><strong>Address: </strong> <span>{{ $satici->address }}</span></li>
                                        <li><img src="assets/imgs/theme/icons/icon-contact.svg" alt="" /><strong>Call Us:</strong><span>{{ $satici->phone }}</span></li>
                                    </ul>
                                </div>
