            ...
            <div class="container">
                <div class="archive-header">
                    <div class="row align-items-center">
                        <div class="col-xl-3">
                            <h1 class="mb-15">Blog & Haberler</h1>
                        ...
                        <div class="shop-product-fillter mb-50 pr-30">
                            ...
                            <div class="sort-by-product-area">
                                ...
                                <div class="sort-by-cover">
                                    <div class="sort-by-product-wrap">
                                        <div class="sort-by">
                                            <span><i class="fi-rs-apps-sort"></i>Tip:</span>
                                        </div>
                                        <div class="sort-by-dropdown-wrap">
                                            <span>Öne Çıkanlar <i class="fi-rs-angle-small-down"></i></span>
                                        </div>
                                    </div>
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a class="active" href="#">Öne Çıkanlar</a></li>
                                            <li><a href="#">En Yeni</a></li>
                                            <li><a href="#">Çoğu Yorum</a></li>
                                            <li><a href="#">Yayın Tarihi</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
...
<article class="wow fadeIn animated hover-up mb-30 animated">
    ...
    <div class="entry-content-2 pl-50">
        ...
        <a href="{{ url('post/detay/'.$post->id.'/'.$post->post_slug) }}">{{ $post->post_baslik }}</a>
        </h3>
        <p class="post-exerpt mb-40">{{ $post->post_kisa_tanim }}</p>
        <div class="entry-meta meta-1 font-xs color-grey mt-10 pb-10">
            <div>
                <span class="post-on">{{ $post->created_at->format('M d Y') }}</span>

            </div>
            <a href="{{ url('post/detay/'.$post->id.'/'.$post->post_slug) }}" class="text-brand font-heading font-weight-bold">Read more <i class="fi-rs-arrow-right"></i></a>
        </div>
    </div>
</article>
            @endforeach                
