...
@endsection
 ...
 <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span> <a href="shop-grid-right.html">
                     ...
                     <span></span> {{ $blogdetay->post_baslik }}
                </div>
            </div>
        </div>
        <div class="page-content mb-50">
            ...
            <h2 class="mb-10">{{ $blogdetay->post_baslik }}</h2>
   ...
   <span class="post-on has-dot">{{ Carbon\Carbon::parse($blogdetay->created_at)->diffForHumans() }}</span>
    ...
    <img src="{{ asset($blogdetay->post_image) }}" alt="" style="height: 400px; display: block; margin-left: auto;  margin-right: auto; width: 70%;"  />
    </figure>
    <div class="single-content">
    <div class="row">
        <div class="col-xl-10 col-lg-12 m-auto">
            <p class="single-excerpt"> {!! $blogdetay->post_uzun_tanim !!} </p>
            <!--Entry bottom-->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <textarea class="form-control w-100" name="comment" id="comment" cols="30" rows="9" placeholder="Yorum Yazınız"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <input class="form-control" name="website" id="website" type="text" placeholder="Websitei" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <button type="submit" class="button button-contactForm">Post Yorum</button>
                    </div>
                </form>
