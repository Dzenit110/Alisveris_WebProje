...
@endsection
 ...
 <p>We found <strong class="text-brand">{{ count($urunler) }}</strong> items for you!</p>
   ...
   <a aria-label="Quick view" class="action-btn" data-bs-toggle="modal" data-bs-target="#quickViewModal" id="{{ $urun->id }}" onclick="productView(this.id)" ><i class="fi-rs-eye"></i></a>
    ...
    @php
    $miktar = $urun->satis_fiyat - $urun->indirimli_fiyat;
    $indirim = ($miktar/$urun->satis_fiyat) * 100;
    @endphp
...
<span class="font-small text-muted">By <a href="vendor-details-1.html">Owner</a></span>
  ...
  <span class="font-small text-muted">By <a href="vendor-details-1.html">{{ $urun['satici']['name'] }}</a></span>
    ...
    @endforeach
    	...
    	@foreach($categoriler as $category)

@php
$products = App\Models\Urun::where('category_id',$category->id)->get();
@endphp
