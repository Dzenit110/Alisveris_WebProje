...
@section('title')
    {{ $subcat->category->category_name }} >  {{ $subcat->subcategory_name }} Subcategory
@endsection
    ...
    <div class="container">
        <div class="archive-header">
            <div class="row align-items-center">
                <div class="col-xl-3">
                    <h5 class="mb-15">{{ $subcat->subcategory_name }}</h5>
                    <div class="breadcrumb">
                        <a href="index.html" rel="nofollow"><i class="fi-rs-home mr-5"></i>Home</a>
                        <span></span>{{ $subcat->category->category_name }} <span></span> {{ $subcat->subcategory_name }}
                    </div>
                </div>
        ...
        <div class="col-lg-4-5">
            <div class="shop-product-fillter">
                <div class="totall-product">
                    <p>We found <strong class="text-brand">{{ count($urunler) }}</strong> items for you!</p>
                </div>
                    ...
                    <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                        ...
                        <div class="product-content-wrap">
                            <div class="product-category">
                                <a href="shop-grid-right.html">{{ $urun['subcategory']['subcategory_name'] }}</a>
                            </div>
                            ...
                            <div class="product-card-bottom">
                                ...
                                @else
                                <div class="product-price">
                                    <span>${{ $urun->indirimli_fiyatdiscount_price }}</span>
                                ...
                                <div class="add-cart">
                                    <a class="add" href="{{ url('urun/detay/'.$urun->id.'/'.$urun->urun_slug) }}"><i class="fi-rs-shopping-cart mr-5"></i>Details </a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
            <div class="sidebar-widget widget-category-2 mb-30">
                ...
                <ul>
                    ...
                    <li>
                        <a href="shop-grid-right.html"> <img src=" {{ asset($category->category_image) }} " alt="" />{{ $category->category_name }}</a><span class="count">{{ count($urunler) }}</span>
                    </li>
                    @endforeach
                </ul>
            </div>
            ...
            <div class="sidebar-widget product-sidebar mb-30 p-30 bg-grey border-radius-10">
                ...
                @foreach($yeniUrun as $urun)
                <div class="single-post clearfix">
                    <div class="image">
                        <img src="{{ asset( $urun->urun_thambnail ) }}" alt="#" />
                    </div>
                    <div class="content pt-10">
                        <p><a href="{{ url('urun/detay/'.$urun->id.'/'.$urun->urun_slug) }}">{{ $urun->urun_name }}</a></p>

                        @if($urun->indirimli_fiyat == NULL)
                        <p class="price mb-0 mt-5">${{ $urun->satis_fiyat }}</p>
                        @else
                        <p class="price mb-0 mt-5">${{ $urun->indirimli_fiyat }}</p>
                        @endif
