    ...
    <div class="container">
        <div class="archive-header">
            <div class="row align-items-center">
                <div class="col-xl-3">
                <h5 class="mb-15">{{ $cat->category_name }}</h5>                    <div class="breadcrumb">
...
<a aria-label="Quick view" class="action-btn" data-bs-toggle="modal" data-bs-target="#quickViewModal" id="{{ $urun->id }}" onclick="productView(this.id)" ><i class="fi-rs-eye"></i></a>
                        ...
                        <div class="product-content-wrap">
                            ...
                            <div class="product-card-bottom">
                                ...
                                @else
                                <div class="product-price">
                                    <span>${{ $urun->indirimli_price }}</span>
                                ...
                                <div class="add-cart">
                                <a class="add" href="{{ url('urun/detay/'.$urun->id.'/'.$urun->urun_slug) }}"><i class="fi-rs-shopping-cart mr-5"></i>Details </a>                                </div>
                            </div>
                        </div>
                    </div>
                </div>
