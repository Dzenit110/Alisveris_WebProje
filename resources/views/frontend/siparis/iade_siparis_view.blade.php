    ...
    <div class="card">
        ...
        <tr>
           ...
           <td>{{ $siparis->miktar }} TL</td>
            ...
            <td> {{ $siparis->iade_sebep }}</td>
            <td> 
@if($siparis->iade_siparis == 0)
<span class="badge rounded-pill bg-warning">İade Talebi Yok</span>

@elseif($siparis->iade_siparis == 1)
<span class="badge rounded-pill bg-danger">Beklemede</span>

@elseif($siparis->iade_siparis == 2)
